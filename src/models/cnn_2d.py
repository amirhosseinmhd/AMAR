"""
[file]          cnn_2d.py
[description]   implement and evaluate WiFi-based model CNN-2D
"""
#
##
import time
...
def run_cnn_2d(data_train_x,
    ...
    #
    ##
    var_macs, var_params = get_model_complexity_info(CNN_2D(var_x_shape, var_y_shape), 
    ...
    for var_r in range(var_repeat):
        ...
        #
        model_cnn_2d = torch.compile(CNN_2D(var_x_shape, var_y_shape).to(device))
        #
